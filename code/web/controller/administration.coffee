...
http.post '/хранилище/изменить', (ввод, вывод) ->
	...
	цепь(вывод)
		...
		.сделать ->
			...
			[
				{ что: 'прописка' },
				{ что: 'создание', чего: 'раздела', какого: { _id: '', путь: 'Физика', id: 'Физика', название: 'Физика' } },
				{ что: 'создание', чего: 'раздела', какого: { _id: '', путь: 'Физика/Электромагнетизм', id: 'Физика/Электромагнетизм', название: 'Электромагнетизм' }, где: { _id: '', путь: 'Физика', id: 'Физика', название: 'Физика' } },
				{ что: 'создание', чего: 'заметки', какой: { _id: '', путь: 'Физика/Материальная точка', id: 'Физика/Материальная точка', название: 'Материальная точка' }, где: { _id: '', путь: 'Физика', id: 'Физика', название: 'Физика' } },
				{ что: 'правка', чего: 'заметки', какой: { _id: '', путь: 'Физика/Материальная точка', id: 'Физика/Материальная точка', название: 'Материальная точка' } },
				{ что: 'перемещение', чего: 'заметки', какой: { _id: '', путь: 'Физика/Материальная точка', id: 'Физика/Материальная точка', название: 'Материальная точка' }, откуда: { _id: '', путь: 'Физика/Электромагнетизм', id: 'Электромагнетизм', название: 'Электромагнетизм' }, куда: { _id: '', путь: 'Физика', id: 'Физика', название: 'Физика' } },
				{ что: 'удаление', чего: 'заметки', какой: { _id: '', путь: 'Физика/Материальная точка', id: 'Физика/Материальная точка', название: 'Материальная точка' } },
...
#			хранилище.collection('people').ensureIndex 'почта', true, @
		...
		.сделать ->
			хранилище.collection('diaries').ensureIndex 'пользователь', no, @
		...
		.сделать ->
			хранилище.collection('journals').ensureIndex 'пользователь', no, @
			
		.сделать ->
			хранилище.collection('journals').ensureIndex 'время', no, @

		.сделать ->
			хранилище.collection('journals').save { пользователь: человек._id, заглавие: 'Запись в журнале', запись: 'АК-12 — российский автомат калибра 5,45 мм, перспективная разработка концерна «Ижмаш»[1]. Этот автомат разрабатывался, чтобы заменить в производстве и, возможно, на вооружении Вооружённых Сил Российской Федерации (ВС России) предыдущие варианты автоматов Калашникова — АК-74 и АК-74М, АК-103 и более ранние АКМ и АКМС.', время: new Date() }, @
		...
		.сделать ->
			...
			[
				{ что: 'прописка' },
				{ что: 'создание', чего: 'раздела', какого: { _id: '', путь: 'Физика', id: 'Физика', название: 'Физика' } },
				{ что: 'создание', чего: 'заметки', какой: { _id: '', путь: 'Физика/Материальная точка', id: 'Материальная точка', название: 'Материальная точка' } },
				{ что: 'загрузка', чего: 'картинки', какой: { альбом: { id: 'Реклама', название: 'Реклама', _id: '' }, id: 'дети 1', _id: '' } },
				{ что: 'загрузка', чего: 'картинки', какой: { альбом: { id: 'Реклама', название: 'Реклама', _id: '' }, id: 'дети 2', _id: '' } },
				{ что: 'загрузка', чего: 'картинки', какой: { альбом: { id: 'Реклама', название: 'Реклама', _id: '' }, id: 'дети 3', _id: '' } },
				{ что: 'добавление', чего: 'видеозаписи', какой: { альбом: { id: 'Художества', название: 'Художества', _id: '' }, _id: '', id: 'Rabbitoyd', источник: 'vimeo.com', внешний_id: '37391578' } },
