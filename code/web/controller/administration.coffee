...
#			хранилище.collection('people').ensureIndex 'почта', true, @
		...
		.сделать ->
			новости =
			[
				{ что: 'прописка', кого: пользовательское.скрыть(человек) },
				{ что: 'создание', чего: 'раздела', какого: { _id: '', id: 'Физика', название: 'Физика' } },
				{ что: 'создание', чего: 'заметки', какой: { _id: '', id: 'Материальная точка', название: 'Материальная точка' } },
