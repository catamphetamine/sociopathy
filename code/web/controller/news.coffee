...
exports.уведомления = (пользователь, возврат) ->
	new Цепочка(возврат)
		...
		.сделать (новости) ->
			...
			for _id, value of новости
				@.$.новости.новости.push(_id)
				
			for _id, value of @._.session.новости.беседы
				@.$.новости.беседы.push(_id)
				
			for _id, value of @._.session.новости.обсуждения
				@.$.новости.обсуждения.push(_id)
