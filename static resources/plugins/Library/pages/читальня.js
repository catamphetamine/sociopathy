(function()
{
	...
	function categories_loaded()
	{
		...
		{
			page.подсказка('удаление разделов и заметок читальни', 'Для того, чтобы удалить раздел (или заметку), просто «выбросите» его (или её) мышью со страницы, и после этого «сохраните правки»')
