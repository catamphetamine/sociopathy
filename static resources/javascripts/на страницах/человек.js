	...
	{	
		...
		({
			...
			get_data: function(data)
			{
				...
				if (is_my_profile())
				{
					var showing_avatar_hint = !data.avatar_version && Подсказка('загрузка картинки', 'Вы можете загрузить себе аватар, перейдя в <a href=\'/помощь/режимы#Режим правки\'>«режим правки»</a> (клавиша «' + Настройки.Клавиши.Режимы.Правка + '»), и нажав на маленькую картинку с совой')
					
					if (!showing_avatar_hint)
						Подсказка('правка личных данных', 'Вы можете дополнить или изменить данные о себе, перейдя в <a href=\'/помощь/режимы#Режим правки\'>«режим правки»</a> (клавиша «' + Настройки.Клавиши.Режимы.Правка + '»)')
				}
